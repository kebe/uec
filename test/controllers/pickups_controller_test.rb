...
class PickupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pickup" do
    assert_difference('Pickup.count') do
      post pickups_url, params: { pickup: { client_id: @pickup.client_id, day: @pickup.day, pickup_date: @pickup.pickup_date, status: @pickup.status } }
    end
  ...
  test "should update pickup" do
    patch pickup_url(@pickup), params: { pickup: { client_id: @pickup.client_id, day: @pickup.day, pickup_date: @pickup.pickup_date, status: @pickup.status } }
